...
cat ${SCRIPT_TMP_DIR}/${CERT_PEM}   | set_reference plain:targets/tesoro/kapicorp-tesoro-cert-pem --base64
cat ${SCRIPT_TMP_DIR}/${CERT_KEY}   | set_reference plain:targets/tesoro/kapicorp-tesoro-cert-key --base64
cat ${SCRIPT_TMP_DIR}/${CACERT_PEM} | set_reference plain:targets/tesoro/kapicorp-tesoro-cacert-pem --base64